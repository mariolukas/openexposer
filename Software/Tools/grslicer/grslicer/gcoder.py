...
class GCodeWriter(object):
    ...
    def exposing_cycles(self, exposingCycles):
        self.write('G04 E{:d}'.format(exposingCycles))
        self.nl()

    def expose_command(self):
        self.write('G06')
        self.nl()
...
class ScanlineGCoder(object):
    ...
    def encode_settings(self):
        self.coder.exposing_cycles(self.s.exposingCycles)


    def encode_start_block(self):
        self.coder.comment('Generated by GRSlicer {}'.format((VERSION,)))
        self.coder.comment('Settings:')
        self.coder.comment('  layerHeight: {}'.format(self.s.layerHeight))
        self.coder.comment('  scanlineSpacing: {}'.format(self.s.scanlineSpacing))
        self.coder.comment('  exposingCycles: {}'.format(self.s.exposingCycles))
